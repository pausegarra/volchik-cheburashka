  ...
  ru: {
    ...
    charactersSection: {
      ...
      cheburashka: {
        name: 'Чебурашка',
        description:
          'Большой ушастый друг, приехавший из России. Нежный, спокойный и наблюдательный. Умеет находить волшебство в мелочах и всегда сначала слушает, прежде чем говорить.',
      },
      volchik: {
        name: 'Волчик',
        description:
